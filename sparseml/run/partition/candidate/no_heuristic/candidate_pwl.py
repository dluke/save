...
parser.add_argument('--trail', action='store_true', 
                    help='operate on the trailing pole')
...
outputdir = '_' + name
print('targeting output directory: %s' % outputdir)
...
loss_conf = {}
# loss_conf["contour_term"] = 0.25
# loss_conf["continuity_term"] = 1
config['loss'] = loss_conf

wavemodel, lptr, meta = pwlpartition.wavelet_guess(track, head=head)
